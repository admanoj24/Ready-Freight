...
//           <div className="flex items-center gap-4 sm:gap-6 text-sm mb-2 sm:mb-0">
//             <Link
//               href="#"
...
//               <div className="mb-3 rounded-full bg-blue-100 p-2 sm:p-3">
//                 <svg
...
//               <Link
//                 href="#"
//                 className="mt-2 sm:mt-3 text-xs sm:text-sm font-medium text-blue-600 hover:underline"
//               >
//                 Track Now
//               </Link>
//             </div>
...
//                 Featured Content
//               </h2>
//               <p className="mx-auto max-w-[700px] text-sm sm:text-base text-gray-500 md:text-xl">
//                 Explore our latest insights, case studies, and success stories.
//               </p>
//             </div>
//           </div>
//           <div className="mx-auto grid max-w-6xl grid-cols-1 gap-6 py-8 sm:py-12 sm:grid-cols-2 md:grid-cols-3">
...
//                 <p className="text-xs sm:text-sm text-gray-500">Case Study</p>
//                 <h3 className="mb-1 sm:mb-2 mt-1 sm:mt-2 text-lg sm:text-xl font-bold line-clamp-2">
//                   Supply Chain Optimization for Major Retailer
//                 </h3>
//                 <p className="mb-3 sm:mb-4 text-xs sm:text-sm text-gray-500 line-clamp-3">
//                   How Ready-Freight helped a national retailer reduce costs and
//                   improve delivery times.
//                 </p>
//                 <Link
//                   href="#"
//                   className="group inline-flex items-center gap-1 text-xs sm:text-sm font-medium text-blue-600"
//                 >
//                   Read more{" "}
...
//               </div>
//               <CardContent className="p-4 sm:p-6">
//                 <p className="text-xs sm:text-sm text-gray-500">Article</p>
//                 <h3 className="mb-1 sm:mb-2 mt-1 sm:mt-2 text-lg sm:text-xl font-bold line-clamp-2">
...
//               </div>
//               <CardContent className="p-4 sm:p-6">
//                 <p className="text-xs sm:text-sm text-gray-500">White Paper</p>
//                 <h3 className="mb-1 sm:mb-2 mt-1 sm:mt-2 text-lg sm:text-xl font-bold line-clamp-2">
...
//             </div>
//           </div>
//           <div className="mx-auto grid max-w-6xl grid-cols-2 gap-3 sm:gap-6 py-8 sm:py-12 md:grid-cols-4">
...
//                 <h3 className="mb-1 sm:mb-2 text-base sm:text-lg font-bold">
//                   Retail
//                 </h3>
